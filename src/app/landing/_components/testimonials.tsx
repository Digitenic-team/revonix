...
export function TestimonialsSection() {
  return (
    <section className="mx-auto mt-30 flex max-w-360 flex-col items-center gap-[4.38rem] self-stretch">
      ...
      <section className="slef-stretch flex flex-wrap items-start gap-5 px-4">
        {CARDS.map((card: Card) => (
          <div
            key={card.text}
            className={cn(
              "flex min-h-70 min-w-80 flex-1 flex-col items-start justify-between rounded-4xl bg-[#F5F7F9] p-6",
            )}
          >
