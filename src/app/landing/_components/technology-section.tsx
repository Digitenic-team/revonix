...
export function TechnologySection() {
  return (
    <section className="relative mx-auto mt-30 flex max-w-456 items-center justify-between gap-50 rounded-[2.5rem] bg-[linear-gradient(180deg,rgba(1,1,1,1)_0%,#3558DA_100%)] bg-cover bg-center p-[6.25rem_5rem] shadow-[0_51px_51px_rgba(54,89,218,0.09),0_13px_28px_rgba(54,89,218,0.1)]">
      ...
      <div className="relative flex w-148.75 shrink-0 flex-col items-start gap-5">
        <Image
        ...
        {CARDS.map((card: Cards, idx: number) => (
          <div
            ...
            className={cn(
              ...
              "flex w-148 flex-col items-start justify-center gap-8 self-stretch rounded-3xl border border-white p-6 shadow-[0_11px_24px_rgba(55,90,217,0.1)]",
            )}
          >
            ...
            <div className="flex w-full items-center justify-between">
              ...
              {idx === 1 && (
                <StyledButton className="px-10 py-5.5">Learn More</StyledButton>
              )}
            </div>
          </div>
        ))}
